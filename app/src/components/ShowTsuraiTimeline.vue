      ...
      <div class="card-footer text-right">
        ...
        <div>
          <stamp kind="too-bad" 
            ...
            :count="num_that_is_too_bad" @click="toggle_too_bad"/>
          <stamp kind="alright" 
            :active="isActive('alright')" :count="num_you_are_alright" @click="toggle_alright"/>
          <stamp kind="good-job" 
            :active="isActive('good-job')" :count="num_good_job" @click="toggle_good_job"/>
        </div>
      </div>
    </div>
  </div>
